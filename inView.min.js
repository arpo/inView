...
outs:{}},$(document.body).append(window.traceOut.container)),a="Visible",b&&(a="Visible: "+b),window.traceOut.outs.Visible?window.traceOut.outs.Visible.html(a):(window.traceOut.container.append($('<div class="Visible">'+a+"</div>")),window.traceOut.outs.Visible=$("#traceOut .Visible")));return c}function m(){k("scroll",function(c){f(e())},300);k("resize",function(c){f(e())},300);m=function(){}}var h=[];return{add:function(c){m();h.push(c)},outOfBoundsSize:2,whatsVisible:e,check:function(){return f(e())},
doTrace:!1,clear:function(){h.length=0}}}();
